...
void	UART_config(void)
{
	...
	COMx_InitStructure.UART_P_SW      = UART1_SW_P36_P37;	//切换端口,   UART1_SW_P30_P31,UART1_SW_P36_P37,UART1_SW_P16_P17,UART1_SW_P43_P44
...
void Init_ESP01S()
{		
	PrintString1("AT+CIPSTART=\"TCP\",\"192.168.43.217\",8086\r\n");   
	delay_ms(5);  
	PrintString1("AT+CIPMODE=1");	   
	delay_ms(5);
	PrintString1("AT+CIPSEND");	
}
